...
public class SecondActivity extends AppCompatActivity {
    ...
    private void init_ClickListeners(){
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String[] peoples = new String[]{"美工：黄静", "杂工：龚飞铃"};
                new AlertDialog.Builder(SecondActivity.this).setTitle("开发人员").setItems(peoples, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(SecondActivity.this,"黄静超美",Toast.LENGTH_SHORT).show();
                    }
                }).show();
            }
        });
